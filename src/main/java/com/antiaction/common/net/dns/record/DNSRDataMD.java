 ...
 */
public class DNSRDataMD implements DNSRDataInterface {
	...
	/** Record of type MD. */
	protected static int rtype = DNSType.MD;
	/** Mail Destination. */
	...
	public byte[] buildPacket(DNSName dnsname, int globalIdx) throws DNSNameException {
		...
		if ( debug ) {
			System.out.println("-> DNSRDataMD.buildPacket()");
			System.out.println("    maildestination: " + name);
		}
	...
	public void disassemblePacket(DNSName dnsname, byte[] pDat, int pIdx, int pLen) throws DNSNameException, DNSRDataException {
		...
		if ( debug ) {
			System.out.println("-> DNSRDataMD.disassemblePacket() - idx=" + pIdx);
		}
	...
	// Mail Destination
		...
		if ( debug ) {
			System.out.println("    maildestination: " + name);
			System.out.println("<- DNSRDataMD.disassemblePacket() - Len=" + disLen);
		}
	}
	 ...
	 */
	public void setMailDestination(String name) {
		this.name = name;
	}
