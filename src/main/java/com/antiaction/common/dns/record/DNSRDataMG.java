 ...
 */
public class DNSRDataMG implements DNSRDataInterface {
	...
	/** Record of type MG. */
	protected static int rtype = DNSType.MG;
	/** Mail Group Member. */
	...
	public byte[] buildPacket(DNSName dnsname, int globalIdx) throws DNSNameException {
		...
		if ( debug ) {
			System.out.println("-> DNSRDataMG.buildPacket()");
			System.out.println("    mailgroup: " + name);
		}
	...
	public void disassemblePacket(DNSName dnsname, byte[] pDat, int pIdx, int pLen) throws DNSNameException, DNSRDataException {
		...
		if ( debug ) {
			System.out.println("-> DNSRDataMG.disassemblePacket() - idx=" + pIdx);
		}
	...
	// Mail Group Member
		...
		if ( debug ) {
			System.out.println("    mailgroup: " + name);
			System.out.println("<- DNSRDataMG.disassemblePacket() - Len=" + disLen);
		}
	}
	 ...
	 */
	public void setMailGroup(String name) {
		this.name = name;
	}
