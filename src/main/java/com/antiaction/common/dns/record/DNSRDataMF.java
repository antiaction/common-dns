 ...
 */
public class DNSRDataMF implements DNSRDataInterface {
	...
	/** Record of type MF. */
	protected static int rtype = DNSType.MF;
	/** Mail Forwarder. */
	...
	public byte[] buildPacket(DNSName dnsname, int globalIdx) throws DNSNameException {
		...
		if ( debug ) {
			System.out.println("-> DNSRDataMF.buildPacket()");
			System.out.println("    mailforwarder: " + name);
		}
	...
	public void disassemblePacket(DNSName dnsname, byte[] pDat, int pIdx, int pLen) throws DNSNameException, DNSRDataException {
		...
		if ( debug ) {
			System.out.println("-> DNSRDataMF.disassemblePacket() - idx=" + pIdx);
		}
	...
	// Mail Forwarder
		...
		if ( debug ) {
			System.out.println("    mailforwarder: " + name);
			System.out.println("<- DNSRDataMF.disassemblePacket() - Len=" + disLen);
		}
	}
	 ...
	 */
	public void setMailForwarder(String name) {
		this.name = name;
	}
