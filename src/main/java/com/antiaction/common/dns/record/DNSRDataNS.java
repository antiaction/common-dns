 ...
 */
public class DNSRDataNS implements DNSRDataInterface {
	...
	/** Record of type NS. */
	protected static int rtype = DNSType.NS;
	/** Name Server. */
	...
	public byte[] buildPacket(DNSName dnsname, int globalIdx) throws DNSNameException {
		...
		if ( debug ) {
			System.out.println("-> DNSRDataNS.buildPacket()");
			System.out.println("    nameserver: " + name);
		}
	...
	public void disassemblePacket(DNSName dnsname, byte[] pDat, int pIdx, int pLen) throws DNSNameException, DNSRDataException {
		...
		if ( debug ) {
			System.out.println("-> DNSRDataNS.disassemblePacket() - idx=" + pIdx);
		}
	...
	// Name Server
		...
		if ( debug ) {
			System.out.println("    nameserver: " + name);
			System.out.println("<- DNSRDataNS.disassemblePacket() - Len=" + disLen);
		}
	}
